...
description: |
  A Distill Article Presenting the Group's Project Proposal
author:
  - name: Group 10
    affiliation: Github 
...
Literature Review (relevant work) 
...
1. An interactive R Shiny dashboard for users to have an overview of government procurement nature and interactions between public sector and suppliers. The dashboard will include a user guide on how to use the data visualization functions designed  
...
- [Group17 Report](https://wiki.smu.edu.sg/1718t3isss608/Group17_Report)
