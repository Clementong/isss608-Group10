...
description: |
  Data Visualisation Group Project: GPExploreR, a Dashboard representing government procurement projects 
...
- **(a) Exploratory Data Analysis Component:** Conduct exploratory data analysis to gain overall understanding of the procurement pattern of both awarded and un-awarded tenders at ministry or agency levels​

![Exploratory Data Analysis Overview](./images/eda_db.png)

- **(b) Network Analysis Component:** Network analysis to identify the key interactions between public agencies and suppliers, and to identify key suppliers that are heavily relied on by the public sector​

![Network Analysis Overview](./images/network_db.png)

- **(c) Text Analysis Component :** Text mining through word cloud and frequency analysis to identify the common nature of procurement by specific public agency and supplier. Topic modelling was also used to study the salient terms and identify project types from tender description. ​
