...
```{r}
htmltools::HTML('<span>Click Here:</span><a href=attachments/UserGuidePDF.pdf> User Guide</a>')

```
xw
```{r}
htmltools::HTML('<span>Click Here:</span><a href=attachments/Poster.pdf> Poster</a>')
```

```{r}
htmltools::HTML('<span>Click Here:</span><a href="https://lostdatafinder.shinyapps.io/Compiled/"> Shiny Application</a>')
```
